    ...
    createGameCard(game, index) {
        ...
        card.innerHTML = `
            <div class="game-card-inner">
                ...
                <div class="game-logo">
                    <img src="${game.logo}" alt="${game.title}" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 200 200%22%3E%3Crect fill=%22%23222%22 width=%22200%22 height=%22200%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 dominant-baseline=%22middle%22 text-anchor=%22middle%22 fill=%22${encodeURIComponent(game.color)}%22 font-size=%2260%22 font-family=%22monospace%22%3E${game.title.substring(0, 2)}%3C/text%3E%3C/svg%3E'">
                </div>
                <div class="game-info">
